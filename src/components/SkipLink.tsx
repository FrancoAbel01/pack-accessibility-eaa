...
//           className="flex items-center gap-2 rounded-lg border-2 border-green-600 bg-black px-4 py-3 text-white shadow-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-green-700 focus:ring-offset-2"
//         >
